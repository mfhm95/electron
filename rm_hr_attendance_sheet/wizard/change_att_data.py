...
class attendance_sheet_line_change(models.TransientModel):
    ...
    float_fix_out = fields.Float("float fix out")
    float_fix_in = fields.Float("float fix in")
    ...
    def default_get(self, fields):
        ...
        if 'overtime' in fields and 'overtime' not in res:
            ...
            res['float_fix_in'] = atts_line_id.float_fix_in
            res['float_fix_out'] = atts_line_id.float_fix_out
        return res
    ...
    def change_att_data(self):
        ...
        res={
            ...
            'float_fix_in':data['float_fix_in'],
            'float_fix_out':data['float_fix_out'],
            'note': data['note'],
